...
exports.generateDiff = function(storeclient,olddate,type,callback) {
    storeclient.getCurrentFilter(type,function(err,result) {
        ...
        storeclient.getFilter(olddate,type,function(err,result) {
            ...
            storeclient.storeDiff(olddate,type,diff,callback);
